...
@Entity
@Table(name = "tecajevi_upload")
public class TecajeviUpload {
    ...
    public TecajeviUpload() {
    }

    public TecajeviUpload(String broj_tecajnice, LocalDate datum_primjene, String drzava, String drzava_iso, String sifra_valute, String valuta, int jedinica, String kupovni_tecaj, String srednji_tecaj, String prodajni_tecaj, Long id) {
    ...
    public TecajeviUpload(String broj_tecajnice, LocalDate datum_primjene, String drzava, String drzava_iso, String sifra_valute, String valuta, int jedinica, String kupovni_tecaj, String srednji_tecaj, String prodajni_tecaj) {
        this.broj_tecajnice = broj_tecajnice;
        this.datum_primjene = datum_primjene;
        this.drzava = drzava;
        this.drzava_iso = drzava_iso;
